...
export default function CaseStudyR6() {
  ...
  return (
    <>
      ...
      <main id="main" className="cs-page" style={{ "--cs-hero-bg": "url(/images/heroes/r6.jpg)" } as React.CSSProperties}>
        {/* Hero Section */}
        ...
        <section className="cs-content">
          <div className="cs-content-container">
            <div className="cs-section animate-on-scroll">
              ...
              <p className="cs-paragraph">R6 Regional Council serves Central Utah communities through workforce development, aging services, community planning, and tax assistance programs — and came to Revize with no established web color palette at all. Their reference points were Mapleton, St. George City, and Apple.com: they wanted the simplicity of a product company applied to regional government. I built the palette from their new building&apos;s gray and black interior — cool charcoal primaries with Utah Sky Blue as the single accent — and exposed their program offerings through an Apple-style mega menu instead of nested dropdowns. The design was approved, verified at 4.5:1 contrast throughout, and handed off for a July 1, 2026 go-live.</p>
