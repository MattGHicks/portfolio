...
export default function CaseStudySouthFork() {
  ...
  return (
    <>
      ...
      <main id="main" className="cs-page" style={{ "--cs-hero-bg": "url(/images/heroes/south-fork.jpg)" } as React.CSSProperties}>
        {/* Hero Section */}
        ...
        <section className="cs-content">
          <div className="cs-content-container">
            <div className="cs-section animate-on-scroll">
              ...
              <p className="cs-paragraph">South Fork Water Board has supplied water to partner cities Oregon City and West Linn since 1915 — a wholesale authority with an informed audience, a small team, and a clear philosophy: &quot;simplicity is brilliant.&quot; The brief was to design a site that felt like their water source — the pristine headwaters of the Clackamas River — not a mechanical treatment facility. Their forest green and light blue brand guidelines already existed, so my job was applying them with restraint on the web: accents and hover states rather than heavy fills, natural imagery in the hero, and &quot;Pure Water Since 1915&quot; doing the trust-building. Navigation was pared to the four things their actual audience needs — Board Meetings, Active Projects, Water Quality, Master Plan.</p>
